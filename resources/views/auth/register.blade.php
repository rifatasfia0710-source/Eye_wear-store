...
<head>
    ...
    <title>Register - VisionStyle</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex w-1/2 gradient-bg relative overflow-hidden items-center justify-center p-12">
            ...
            <div class="relative z-10 text-center max-w-lg">
                ...
                <h1 class="text-white text-6xl font-extrabold mb-6 leading-tight">VisionStyle</h1>
                <p class="text-white text-xl opacity-95 leading-relaxed mb-12">Create an account and unlock access to premium eyewear collections tailored to your style.</p>
                ...
                <!-- <div class="text-left space-y-4 max-w-sm mx-auto">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h3 class="text-white font-semibold text-lg">Exclusive Collections</h3>
                            <p class="text-white opacity-90 text-sm">Access to limited edition frames</p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        <svg class="w-6 h-6 text-white mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <h3 class="text-white font-semibold text-lg">Member Discounts</h3>
                            <p class="text-white opacity-90 text-sm">Save up to 20% on all orders</p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        <svg class="w-6 h-6 text-white mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <h3 class="text-white font-semibold text-lg">Free Shipping</h3>
                            <p class="text-white opacity-90 text-sm">On orders over $50</p>
                        </div>
                    </div>
                </div> -->
            </div>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="glass-effect shadow-2xl rounded-3xl p-8 lg:p-10">
                    ...
                    <div class="mb-8">
                        ...
                        <!-- <p class="text-gray-600">Join thousands of style enthusiasts</p> -->
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-5">
                        ...
                        <p class="text-center text-gray-600 mt-6">
                            ...
                            <a href="{{ route('login') }}" class="text-purple-600 font-semibold hover:text-purple-700 transition">Sign In</a>
                        </p>
                    </form>
